  ...
  return (
    <div className="min-h-screen bg-black text-white py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-5xl font-bold mb-12 tracking-widest">PRIVACY POLICY</h1>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">INFORMATION WE COLLECT</h2>
          
          <h3 className="text-2xl font-bold mt-10 mb-6 tracking-wider">PERSONAL INFORMATION</h3>
          ...
          <h3 className="text-2xl font-bold mt-10 mb-6 tracking-wider">NON-PERSONAL INFORMATION</h3>
          <p className="text-gray-300 mb-6 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">HOW WE USE YOUR INFORMATION</h2>
          <p className="text-gray-300 mb-6 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">HOW WE PROTECT YOUR INFORMATION</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">COOKIES</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">THIRD-PARTY SERVICES</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">DATA RETENTION</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">YOUR RIGHTS</h2>
          <p className="text-gray-300 mb-6 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">CHANGES TO THIS PRIVACY POLICY</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-16 mb-8 tracking-wider">CONTACT US</h2>
          <p className="text-gray-300 mb-6 text-lg leading-relaxed">
