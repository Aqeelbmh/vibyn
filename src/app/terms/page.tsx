  ...
  return (
    <div className="min-h-screen bg-black text-white py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-5xl font-bold mb-12 tracking-widest">TERMS AND CONDITIONS</h1>
        <p className="text-gray-400 mb-16 text-lg">Last updated: {new Date().toLocaleDateString(`en-GB`)}</p>
        
        <div className="prose prose-invert max-w-none">
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">1. INTRODUCTION</h2>
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">2. INTELLECTUAL PROPERTY</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">3. USER RESPONSIBILITIES</h2>
          <p className="text-gray-300 mb-6 text-lg leading-relaxed">
            As a user of our website, you agree not to:
          </p>
          <ul className="list-disc list-inside text-gray-300 mb-8 space-y-3 text-lg">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">4. ORDERS AND PAYMENTS</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">5. PRICING AND AVAILABILITY</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">6. SHIPPING AND DELIVERY</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">7. RETURNS AND REFUNDS</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">8. LIMITATION OF LIABILITY</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">9. GOVERNING LAW</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">10. CHANGES TO TERMS</h2>
          <p className="text-gray-300 mb-8 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 tracking-wider">11. CONTACT INFORMATION</h2>
          <p className="text-gray-300 mb-6 text-lg leading-relaxed">
