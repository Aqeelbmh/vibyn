    ...
    <div className="min-h-screen bg-white text-black py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-28">
          <h1 className="text-5xl md:text-6xl font-bold mb-8 tracking-widest text-[#d4af37]">ABOUT VIBYN</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-28">
          ...
          <div>
            <div 
              ...
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?q=80&w=800')", backgroundBlendMode: "overlay", backgroundColor: "rgba(255, 255, 255, 0.4)" }}
            >
              <div className="w-full h-full rounded-2xl flex items-center justify-center">
                <div className="text-center p-6 bg-white/50 backdrop-blur-sm rounded-xl">
                  ...
                  <p className="text-black">Our journey of energy and authenticity</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-28">
          <div className="order-2 lg:order-1">
            <div 
              className="h-96 bg-cover bg-center rounded-2xl shadow-2xl border border-[#d4af37]/30 backdrop-blur-sm"
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=800')", backgroundBlendMode: "overlay", backgroundColor: "rgba(255, 255, 255, 0.4)" }}
            >
              <div className="w-full h-full rounded-2xl flex items-center justify-center">
                <div className="text-center p-6 bg-white/50 backdrop-blur-sm rounded-xl">
                  <h3 className="text-2xl font-bold text-[#d4af37] mb-2">Our Mission</h3>
                  <p className="text-black">Empowering authentic self-expression</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center py-20 mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="p-10 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 hover:border-[#d4af37] transition-colors">
              <div className="text-6xl mb-6 text-[#d4af37]">✨</div>
              <h3 className="text-2xl font-bold mb-5 tracking-wider text-[#d4af37]">AUTHENTICITY</h3>
            ...
            <div className="p-10 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 hover:border-[#d4af37] transition-colors">
              <div className="text-6xl mb-6 text-[#d4af37]">🏆</div>
              <h3 className="text-2xl font-bold mb-5 tracking-wider text-[#d4af37]">QUALITY</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="p-10 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 hover:border-[#d4af37] transition-colors">
              <div className="text-6xl mb-6 text-[#d4af37]">🤝</div>
              <h3 className="text-2xl font-bold mb-5 tracking-wider text-[#d4af37]">CONNECTION</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        {/* Team */}
        <div className="py-20">
          <h2 className="text-4xl font-bold text-center mb-20 tracking-wider text-[#d4af37]">MEET OUR TEAM</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              <div className="w-48 h-48 rounded-full mx-auto mb-8 bg-cover bg-center border-4 border-gray-200 group-hover:border-[#d4af37] transition-colors" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400')" }}></div>
            ...
            <div className="text-center group">
              <div className="w-48 h-48 rounded-full mx-auto mb-8 bg-cover bg-center border-4 border-gray-200 group-hover:border-[#d4af37] transition-colors" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=400')" }}></div>
            ...
            <div className="text-center group">
              <div className="w-48 h-48 rounded-full mx-auto mb-8 bg-cover bg-center border-4 border-gray-200 group-hover:border-[#d4af37] transition-colors" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=400')" }}></div>
