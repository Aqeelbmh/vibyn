  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f0f0f0]">
      ...
      <section className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden rounded-2xl sm:rounded-3xl my-4 sm:my-8">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a]/70 via-[#2c1810]/50 to-[#0a0a0a]/80 z-10 rounded-2xl sm:rounded-3xl"></div>
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl">
          ...
          <p className="text-base sm:text-lg md:text-2xl mb-6 sm:mb-10 tracking-wide font-light text-[#f0f0f0]/90">
            Your Vibe. Your Identity.
          </p>
          <Link 
            href="/shop" 
            className="inline-block bg-gradient-to-r from-[#d4af37] to-[#b8860b] text-[#2c1810] px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-medium rounded-full hover:from-[#b8860b] hover:to-[#8b4513] transition-all duration-300 transform hover:scale-105 tracking-wider shadow-2xl hover:shadow-3xl"
          >
            DISCOVER COLLECTION
          </Link>
        </div>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-[#0a0a0a] to-[#2c1810]/20 rounded-2xl sm:rounded-3xl my-4 sm:my-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-[#f0f0f0]/90 text-base sm:text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Link href="/shop?category=tshirts" className="text-[#f0f0f0] text-xl sm:text-2xl font-bold bg-[#0a0a0a] bg-opacity-50 px-6 py-3 sm:px-8 sm:py-4 rounded-full hover:bg-opacity-70 transition-all tracking-wider border border-[#d4af37] hover:border-[#b8860b] backdrop-blur-sm">
                  T-SHIRTS
                </Link>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Link href="/shop?category=hoodies" className="text-[#f0f0f0] text-xl sm:text-2xl font-bold bg-[#0a0a0a] bg-opacity-50 px-6 py-3 sm:px-8 sm:py-4 rounded-full hover:bg-opacity-70 transition-all tracking-wider border border-[#d4af37] hover:border-[#b8860b] backdrop-blur-sm">
                  HOODIES
                </Link>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Link href="/dtf-design" className="text-[#f0f0f0] text-xl sm:text-2xl font-bold bg-[#0a0a0a] bg-opacity-50 px-6 py-3 sm:px-8 sm:py-4 rounded-full hover:bg-opacity-70 transition-all tracking-wider border border-[#d4af37] hover:border-[#b8860b] backdrop-blur-sm">
                  DTF DESIGNS
                </Link>
              </div>
            </div>
      ...
      {/* Core Values Section */}
      <section className="py-12 sm:py-16 bg-gradient-to-r from-[#2c1810] to-[#0a0a0a] rounded-2xl sm:rounded-3xl my-4 sm:my-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-[#1a1a1a]/50 p-6 sm:p-8 rounded-2xl border border-[#333333]/30 hover:border-[#d4af37]/50 transition-all duration-300">
              ...
              <p className="text-[#f0f0f0]/80 leading-relaxed text-sm sm:text-base">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
            <div className="lg:w-1/2">
              <div 
                className="h-64 sm:h-80 md:h-96 bg-cover bg-center rounded-2xl shadow-2xl border border-[#d4af37]/30"
              ...
              >
                <div className="w-full h-full rounded-2xl flex items-end justify-start">
                  <div className="p-4 sm:p-6 bg-black/50 backdrop-blur-sm rounded-xl m-4">
                    <h3 className="text-lg sm:text-xl font-bold text-[#d4af37] mb-1">The VIBYN Journey</h3>
                    <p className="text-white text-sm sm:text-base">From Sri Lanka to the streets of the UK</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="lg:w-1/2">
              ...
              <p className="text-[#f0f0f0]/80 mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed">
              ...
              <p className="text-[#f0f0f0]/80 mb-6 sm:mb-10 text-base sm:text-lg leading-relaxed">
              ...
              <Link 
                href="/about" 
                className="inline-block bg-gradient-to-r from-[#d4af37] to-[#b8860b] text-[#2c1810] px-6 py-3 sm:px-8 sm:py-4 font-medium rounded-full hover:from-[#b8860b] hover:to-[#8b4513] transition-all tracking-wider shadow-lg"
              >
                LEARN MORE
              </Link>
            </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-gradient-to-r from-[#2c1810] to-[#0a0a0a] rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 tracking-wide text-[#d4af37]">OUR MISSION</h2>
            <p className="text-[#f0f0f0]/90 text-base sm:text-xl max-w-4xl mx-auto leading-relaxed">
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center mb-12 sm:mb-16">
            ...
            <Link href="/shop" className="text-[#f0f0f0]/60 hover:text-[#d4af37] transition-colors font-medium tracking-wider flex items-center text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="group bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="relative overflow-hidden">
                ...
                ></div>
                <div className="absolute top-4 right-4 bg-[#d4af37] text-[#2c1810] text-xs sm:text-sm font-bold px-2 py-1 sm:px-3 sm:py-1 rounded-full">
                  New
                </div>
              </div>
              <div className="p-4 sm:p-6">
                <h3 className="font-bold text-lg sm:text-xl mb-1 text-[#f0f0f0]">Premium Cotton Tee</h3>
                <p className="text-[#f0f0f0]/60 mb-4 text-sm sm:text-base">Classic fit with premium fabric</p>
                <p className="text-[#f0f0f0] font-bold text-lg">£29.99</p>
              </div>
            </div>
            ...
            <div className="group bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="font-bold text-lg sm:text-xl mb-1 text-[#f0f0f0]">Urban Hoodie</h3>
                <p className="text-[#f0f0f0]/60 mb-4 text-sm sm:text-base">Warm and comfortable</p>
                <p className="text-[#f0f0f0] font-bold text-lg">£59.99</p>
              </div>
            </div>
            ...
            <div className="group bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="font-bold text-lg sm:text-xl mb-1 text-[#f0f0f0]">DTF Graphic Tee</h3>
                <p className="text-[#f0f0f0]/60 mb-4 text-sm sm:text-base">Limited edition design</p>
            ...
            <div className="group bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="font-bold text-lg sm:text-xl mb-1 text-[#f0f0f0]">Signature Hoodie</h3>
                <p className="text-[#f0f0f0]/60 mb-4 text-sm sm:text-base">Our best-selling hoodie</p>
                <p className="text-[#f0f0f0] font-bold text-lg">£64.99</p>
              </div>
            </div>
          </div>
        </div>
